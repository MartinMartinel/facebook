...
describe ProfilesController do
  ...
  before(:each) do
    sign_in user
    request.env["HTTP_REFERER"] = newsfeed_path(user) unless request.nil? or request.env.nil?
  end
  ...
  describe "GET show" do
    ...
    context "for non-friend of current user with private profile" do
      ...
      it "redirects to user's root path" do
        expect(response).to redirect_to(newsfeed_path(user))
      end
    end
  end
  ...
  describe "PATCH update" do
    context "for current user" do
      ...
      it "updates the profile" do
        expect(profile.email_notification).to be_falsey
      end
